...
_Startup:   LDS   #RAMEnd+1     ; Initialize the stack pointer
            ...
            BCLR TSCR2, $FF     ; Configure timer control register
            BSET TSCR1, BIT7    ; Turn timer on
...
MAIN:       BRCLR PORTT,BIT0,C_RESET    ; Reset is first priority
            ...
            JSR TDelay                  ; Delay using the timer
...
;*************************************************************
 TDelay:    PSHB
            BRSET PORTT, BIT5, TD_Delay2
            LDAB #DELAY1      ; PT5 is unset, set delay to 1s
            BRA TD_Start
 TD_Delay2: LDAB #DELAY2      ; PT5 is set, set delay to 0.5s
 TD_Start:  TST TFLG2
            BPL TD_Start      ; Wait until TOF=0
            BSET TFLG2, BIT7  ; Reset TOF
            DBNE B, TD_Start
            PULB
            RTS
